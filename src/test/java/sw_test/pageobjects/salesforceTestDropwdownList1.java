...
public class salesforceTestDropwdownList1 {
    ...
    public void ChromeTest() throws Exception {
       ...
       // }
        ...
        public void accountPickListOptions() {
            ...
            String accView= "All Accounts;All Accounts sw;All Accounts;Credit Limit Review;Low Utilisation;My Accounts;New Auction Partner G3;New This Week;Non Prospect;Prospect Qualified;Recently Viewed Accounts;StockMaster;Suspects;Test 2;Test Accounts";
            ...
            for(String str:arraccView) {
                ...
                if(!found) {
                    System.out.println(str+" option is not listed!!!!");
                }
            }
